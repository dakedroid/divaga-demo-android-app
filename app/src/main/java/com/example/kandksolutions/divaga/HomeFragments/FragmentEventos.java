...
public class FragmentEventos extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public ContentAdapter(Context context) {
            ...
            mPlaces = resources.getStringArray(R.array.eventos_titulos);
            mPlaceDesc = resources.getStringArray(R.array.eventos_descripciones);
            TypedArray a = resources.obtainTypedArray(R.array.eventos_imagenes);
